/*
    O que precisamos fazer? - quando clicar no botão do personagem na lista, temos que marcar o botão como selecionado e mostrar o personagem correspondente.
        ...
        OBJETIVO 1 - quando clicar no botão do personagem na lista, marcar o botão como selecionado
            ...
            passo 3 - verificar se já existe um botão selecionado, e se sim, devemos remover a seleção dele.
            
        OBJETIVO 2 - quando clicar no botão do personagem mostrar as informaões do personagem.
            passo 1 - pegar os persoangens no JS pra poder mostrar ou esconder ele.
